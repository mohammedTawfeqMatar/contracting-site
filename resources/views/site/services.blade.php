...
@section('content')
    <section id="services" class="services section-py">
      <div class="container">
        ...
        <div class="svc-grid">
          <a class="svc-card reveal" href="{{ route('services.details', 'construction') }}" aria-label="التعمير والبناء" style="--delay:0ms">
          ...
          <a class="svc-card reveal" href="{{ route('services.details', 'architecture') }}" aria-label="أعمال الهناجر والبيوت الجاهزة" style="--delay:80ms">
          ...
          <a class="svc-card reveal" href="{{ route('services.details', 'finishes') }}" aria-label="التشطيبات" style="--delay:160ms">
          ...
          <a class="svc-card reveal" href="{{ route('services.details', 'civil') }}" aria-label="الهندسة المدنية" style="--delay:240ms">
          ...
          <a class="svc-card reveal" href="{{ route('services.details', 'equipment') }}" aria-label="المعدات الثقيلة" style="--delay:320ms">
           ...
           <a class="svc-card reveal" href="{{ route('services.details', 'armored-doors') }}" aria-label="أعمال أبواب مدرعة" style="--delay:320ms">
           ...
           <a class="svc-card reveal" href="{{ route('services.details', 'decor') }}" aria-label="الديكورات والإثاث" style="--delay:320ms">
           ...
           <a class="svc-card reveal" href="{{ route('services.details', 'tents') }}" aria-label="المضلات والخيام" style="--delay:320ms">
